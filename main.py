...
icon_editar = PhotoImage(file="edit.png").subsample(2, 2)
icon_deletar = PhotoImage(file="delete.png").subsample(2, 2)
...
botao_adicionar = tk.Button(frame, text="Adicionar Tarefa", bg="#4CAF50", fg="white", height=1, width=15, font=("Roboto", 11), relief=tk.FLAT, command=adicionar_tarefa)
